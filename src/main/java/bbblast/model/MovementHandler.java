...
/**
 * 
 * The interface which models a MovementHandler that handles the movements on a
 * 2D surface.
 *
 */
public interface MovementHandler {
     ...
     *         false if it couldn't and the MovingBubble must be attached to the
     *         grid or there is no MovingBubble set
     */
    boolean handle();
     ...
     * 
     * @return an {@link Optional} of the currently moving shot or optional empty if
     *         no shot is set
     */
